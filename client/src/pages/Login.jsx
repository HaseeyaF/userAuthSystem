...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            ...
            if(state === 'Sign Up'){
                const { data } = await axios.post(`${backendUrl}/api/auth/register`, {name, email, password})   //api call
                ...
                const { data } = await axios.post(backendUrl + '/api/auth/login', {email, password})   //api call
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-gray-200 to-blue-300'>
